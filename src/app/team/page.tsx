        ...
        <>
            <div className="relative">
                ...
                <div className="relative base-container pt-8 pb-24 text-center">
                    ...
                    <p className="font-bold lg:max-w-md mx-auto">Een introductietekst is wel een aanrader voor deze pagina.
            ...
            <div className="relative bg-lichtblauw/11 py-24 overflow-hidden">
                ...
                <div className="base-container text-center">
                    <h2 className="text-3xl font-bold text-lichtblauw mb-6">Parnters</h2>
