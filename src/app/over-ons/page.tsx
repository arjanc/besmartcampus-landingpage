        ...
        <div className="relative pb-28">
            ...
            <div className="base-container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-18">
                    <div>
                        <p>Tijdens mijn vwo-periode begreep ik niets van wiskunde. Totdat één docent het anders uitlegde - en alles op z'n plek viel. Het werd het begin van een mooie reis met afgeronde studies bedrijfswiskunde, informatica, economie en econometrie. </p>
