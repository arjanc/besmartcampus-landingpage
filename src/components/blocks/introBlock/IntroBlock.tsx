        ...
        <div className="relative z-1 base-container pb-24">
            <div className="flex flex-col md:flex-row flex-wrap gap-18">
                ...
                <div className="flex flex-1 w-full items-center md:w-1/2">
                    <Videoplayer
                        sources={[
                            {"src": "https://storage.googleapis.com/gcs-pj-ai-mvp-tmp-prod-videos/aftermovie-besmart-campus-leerfestival_480p_.mp4", media:"(max-width: 600px)"},
                            {"src": "https://storage.googleapis.com/gcs-pj-ai-mvp-tmp-prod-videos/aftermovie-besmart-campus-leerfestival_720p_.mp4", media:"(max-width: 1200px)"},
                            {"src": "https://storage.googleapis.com/gcs-pj-ai-mvp-tmp-prod-videos/aftermovie-besmart-campus-leerfestival_1080p_.mp4"}
                          ]}
